I use [GNU Stow](https://www.gnu.org/software/stow/) to manage a symlink farm. You can install it with your distribution's package manager. It's a very simple program; to learn how to use it, just type `man stow` in your terminal and you'll find everything you need.
